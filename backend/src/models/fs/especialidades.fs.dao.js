...
const DATA_PATH = path.resolve(__dirname, "../../../data/especialidades.json");
...
class EspecialidadesFsDAO extends BaseDAO {
  async create(data) {
  ...
  async findById(id) {
    const items = await readAll();
    return items.find((e) => e._id === id) || null;
  }
...
export default EspecialidadesFsDAO;
